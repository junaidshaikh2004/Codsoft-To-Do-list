...
class todo:
    def __init__(self, root):
        ...
        self.label = Label(self.root, text='To-Do-List App', 
                           font='ariel, 25 bold', width=10, bd=5, bg='aquamarine', fg='black')
        self.label.pack(side='top', fill=BOTH)

        self.label2 = Label(self.root, text='Tasks', 
                           font='ariel, 18 bold', width=10, bd=5, bg='aquamarine', fg='black')
        ...
        self.text = Text(self.root, width=30, height=2, bd=5, font="ariel, 10 bold")
        self.text.place(x=20, y=120)

        # adding recived task to the list:
        ...
        self.button = Button(self.root, text="Add", font='sarif, 20 bold italic', 
                             width=10, bd=5, bg='aquamarine', fg='black', command=add)
        self.button.place(x=30, y=180)

        self.button2 = Button(self.root, text="Delete", font='sarif, 20 bold italic', 
                             width=10, bd=5, bg='aquamarine', fg='black', command=delete)
